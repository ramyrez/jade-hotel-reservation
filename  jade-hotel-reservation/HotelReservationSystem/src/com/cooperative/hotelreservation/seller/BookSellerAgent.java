...
public class BookSellerAgent extends Agent {
	...
	private class CallForOfferServer extends ContractNetResponder {
		...
		CallForOfferServer() {
			super(BookSellerAgent.this, MessageTemplate.and(MessageTemplate
		...
		protected ACLMessage handleCfp(ACLMessage cfp) throws RefuseException,
			 ...
			 */{
				try {
					...
					myGui.notifyUser("Received Proposal to buy "
							+ book.getTitle());
					PriceManager pm = (PriceManager) catalogue.get(book
							.getTitle());
					if (pm != null) {
			...
			myGui
					.notifyUser(reply.getPerformative() == ACLMessage.PROPOSE ? "Sent Proposal to sell at "
							+ price
