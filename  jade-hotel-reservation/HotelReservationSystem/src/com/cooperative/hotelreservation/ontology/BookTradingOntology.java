...
public class BookTradingOntology extends Ontology implements
		BookTradingVocabulary {
	// The name identifying this ontology
	public static final String ONTOLOGY_NAME = "Book-trading-ontology";

	/**
	 * As explained in section 5.1.3.6 pag. 90, it is suggested to move all the
	 * following constants, which represent the Vocabulary of the ontology, into
	 * the BookTradingVocabulary interface // VOCABULARY public static final
	 * String BOOK = "Book"; public static final String BOOK_TITLE = "title";
	 * public static final String BOOK_AUTHORS = "authors"; public static final
	 * String BOOK_EDITOR = "editor"; public static final String COSTS =
	 * "Costs"; public static final String COSTS_ITEM = "item"; public static
	 * final String COSTS_PRICE = "price"; public static final String SELL =
	 * "Sell"; public static final String SELL_ITEM = "item";
	 **/
